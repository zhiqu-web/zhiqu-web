...
<div class="contant_weizhi">
       <form id ="" method="post">
     <table border="0">
      <caption style="font-size:20px; margin-bottom:10px;">增加学生用户</caption>
      <tr style="width:350px;height:50px;">
        <td style="width:250px;height:30px;font-size:16px;">学生账号：
          <input style="width:160px;height:23px;" name="username" type="text" class="control-text" data-rules="{required:true}">
        </td>
      </tr>
      <tr style="width:350px;height:50px;">
        <td style="width:250px;height:30px;font-size:16px;">学生姓名：
          <input style="width:160px;height:23px;" name="realname" type="text" class="control-text" data-rules="{required:true}">
        </td>
      </tr>
      <tr style="width:350px;height:50px;">
        <td style="width:250px;height:30px;font-size:16px;">登录密码：
          <input style="width:160px;height:23px;" name="password" type="password" class="control-text" data-rules="{required:true}">
        </td>
      </tr>
      <tr style="width:350px;height:50px;">
        <td style="width:250px;height:30px;font-size:16px;">性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：
          <select style="width:160px;height:23px;" name="sex">
      ...
      <tr style="width:350px;height:50px;">
        <td style="width:250px;height:30px;font-size:16px;">联系地址：
          <input style="width:160px;height:23px;" name="address" type="text" class="control-text"  data-rules="{required:true}">
        </td>
      </tr>
      <tr style="width:350px;height:50px;">
        <td style="width:250px;height:30px;font-size:16px;">联系方式：
          <input style="width:160px;height:23px;" name="tel" type="text" class=" control-text" data-rules="{required:true}">
        </td>
      </tr>
      <tr style="width:350px;height:50px;">
        <td style="width:250px;height:30px;font-size:16px;">头&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;像：
