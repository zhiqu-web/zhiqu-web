...
<div class="contant_weizhi2">
  <div class="">
    ...
    <thead>
      <tr>
      <th class="th_bg" >管理员账号</th>
      <th class="th_bg" >管理员姓名</th>
    ...
    <tbody>
      <tr>
      <td class="td_bg" >James Camera</td>
      <td class="td_bg" >31</td> 
      <td class="td_bg" >Male</td>
      <td class="td_bg" >12345678901</td>
      <td class="td_bg" >British Columbia</td>
      <td class="td_bg" >Hiking</td>
      <td class="td_bg" >
        <a title="编辑" data-toggle="modal"  href="#myModal" onclick="member_edit('回复','member-add.html','4','','510')" style="text-decoration:none">修改</a>
      </td>
      </tr>
    </tbody>
    </table>
        ...
        <form id="J_Form" class="form-horizontal span24">
            <div class="row">
                <div class="control-group span8" >
                  <label class="control-label"><s>*</s>管理员账号：</label>
                  <div class="controls">
