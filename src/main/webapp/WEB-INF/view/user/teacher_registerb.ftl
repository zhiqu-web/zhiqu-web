...
<div class="contant_weizhi">
       <form id ="" method="post">
     <table border="0">
      <caption style="font-size:20px; margin-bottom:10px;">增加教师用户</caption>
      <tr style="width:350px;height:50px;">
        <td style="width:250px;height:30px;font-size:16px;">教师账号：
          <input style="width:160px;height:23px;" name="username" type="text" class="control-text" data-rules="{required:true}">
        </td>
      </tr>
      <tr style="width:350px;height:50px;">
        <td style="width:250px;height:30px;font-size:16px;">教师姓名：
