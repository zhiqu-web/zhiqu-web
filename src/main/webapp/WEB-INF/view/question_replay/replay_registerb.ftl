...
<div class="contant_weizhi">
       <form id ="" method="post">
     <table border="0">
      <caption style="font-size:20px; margin-bottom:10px;">发布论坛信息</caption>
      <tr style="width:550px;height:50px;">
        <td style="width:500px;height:30px;font-size:16px;">问题标题：
          <input style="width:250px;height:23px;" name="title" type="text" class="control-text" data-rules="{required:true}">
        </td>
      </tr>
      <tr style="width:550px;height:100px;">
        <td style="width:500px;height:100px;font-size:16px;">问题内容：
          <input style="width:250px;height:100px;" name="content" type="text" class="control-text"  data-rules="{required:true}">
        </td>
      </tr>
      <tr style="width:550px;height:70px;">
