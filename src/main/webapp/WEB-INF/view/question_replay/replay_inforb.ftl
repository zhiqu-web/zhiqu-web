...
<div class="contant_weizhi2">
  ...
  <div id="page">
    ...
    <thead>
      <tr>
      <th class="th_bg" style="width:500px;" >问&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题</th>
    ...
    <tbody>
      <tr>
      <td class="td_bg" style="width:500px;">该系统是否好用</td>
        ...
        <form id="J_Form" class="form-horizontal span24">
            <div class="row">
                <div class="control-group span15">
                  <label class="control-label" style="margin-top:30px;"><s>*</s>回复内容：</label>
                  <div class="controls control-row4" style="margin-top:30px;">
                    <textarea name="replay" class="input-large" data-tip="{text:'请填写备注信息！'}" type="text"></textarea>
                   </div>
                </div>
            </div>
