...
<div class="contant_weizhi">
       <form id ="" method="post">
     <table border="0">
      <caption style="font-size:20px; margin-bottom:10px;">发布课程信息</caption>
      <tr style="width:350px;height:50px;">
        <td style="width:250px;height:30px;font-size:16px;">课程名称：
      ...
      <tr style="width:350px;height:100px;">
        <td style="width:250px;height:100px;font-size:16px;">课程介绍：
