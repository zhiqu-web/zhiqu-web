...
<div class="contant_weizhi2">
  ...
  <div id="page">
    ...
    <thead>
      <tr>
      <th class="th_bg" style="width:150px;" >资料名称</th>
      <th class="th_bg" >资料类型</th>
      <th class="th_bg" >发布时间</th>
      <th class="th_bg" >发布人</th>
      <th class="th_bg" >资料下载</th>
      <th class="th_bg" style="width:250px;" >课程简介</th>
      <th class="th_bg" >审核</th>
      <th class="th_bg" style="width:150px;">操&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;作</th>
      </tr>
    </thead>
    <tbody>
      <tr>
      <td class="td_bg" style="width:200px;">中国古诗词的鉴赏分析</td>
      <td class="td_bg">文学类</td>
      <td class="td_bg">2016-8-21</td> 
      <td class="td_bg">张晶</td>
      <td class="td_bg"><a href="">download</a></td>
      <td class="td_bg" style="width:300px;">这是一部非常经典的关于介绍古典文学的作品，其语言精辟，值得阅读。</td>
      <td class="td_bg"><a href="#">未审核</a></td>
      <td class="td_bg"style="width:150px;">
        ...
        <form id="J_Form" class="form-horizontal span24">
            ...
            <div class="row">
                <div class="control-group span15">
                  <label class="control-label"><s>*</s>课程类型：</label>
                  <div class="controls control-row4">
                      <select name="fl">
                        <option value="0" name="">文学类</option>
                        <option value="1" name="">外语类</option>
                        <option value="2" name="">计算机类</option>
                        <option value="3" name="">数学类</option>
                      </select>
                   </div>
                </div>
            </div>
          ...
          <div class="control-group span15 ">
              <label class="control-label"><s>*</s>附&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;件：</label>
              <div class="controls"> 
                <span >
            ...
            <div class="row">
                <div class="control-group span15">
                  <label class="control-label"><s>*</s>资料简介：</label>
                  <div class="controls control-row4">
