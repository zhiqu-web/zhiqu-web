...
<div class="contant_weizhi2">
  ...
  <div id="page">
    ...
    <thead>
      <tr>
      <th class="th_bg" style="width:350px;" >标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题</th>
    ...
    <#if newsList??>
       <#list newsList as news>
       	<tr>
      <td class="td_bg" style="width:350px;">${news.title}</td>
      <td class="td_bg">${news.addtime}</td> 
      <td class="td_bg">${news.adder}</td>
      <td class="td_bg"style="width:200px;">
     <a title="编辑" data-toggle="modal"  href="${rc.contextPath}/newsBackDetail/${news.id}" onclick="member_edit('回复','member-add.html','4','','510')" style="text-decoration:none">修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;
