var zhiqu = function ($) {
    ...
    if (!$) throw Error('zhiqu.js required jquery core');
    ...
    return {
         ...
         * @param options
         * {
         *      templateKey : 'zhiqu.template.key'
        ...
        Pagination: function (options) {
            ...
            this.to = function (pageNum) {
                ...
                var thiz = this;
                zhiqu.template.renderTemplateByKey(this.templateKey, {
...
//                    $('.modal-scrollable').remove();
                    ...
                    if(btnCloseVisible) {
                        ...
                        $layerCloseButton.click(function(e) {
                            zhiqu.widgets.layerManager.close({layerKey : layerKey, targetSelector : targetSelector});
                        });
                    ...
                    if(!templateKey) {
                        ...
                        zhiqu.template.renderTemplateByKey(templateKey, templateParam, {
